          ...
          <div className="px-7 py-6 flex flex-col card">
            <div className="relative">
              ...
              <img
                width={133}
                height={112}
                className="m-auto mb-3.5"
                src="/img/sneakers/image2.png"
                alt="sneakers"
              />
            </div>
